...
package navclus.ui.monitor.selections;

import navclus.ui.monitor.selections.data.SelectionList;
...
//
	private void printSelectionIfTrigger() {
		...
		Display.getDefault().asyncExec(new Runnable() {
			public void run() {
				ClassView.getDefault()
						.getPatternSelector()
						.showRecommendations(selectionList.getSelectionElements());
				selectionList.clear();
			}
		});
