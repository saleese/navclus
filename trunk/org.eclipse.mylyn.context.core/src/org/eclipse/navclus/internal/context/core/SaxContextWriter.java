...
import org.eclipse.navclus.context.core.IInteractionContext;
...
public class SaxContextWriter implements IInteractionContextWriter {
	...
	private Attributes createEventAttributes(InteractionEvent ie) {
		...
		ieAttributes.addAttribute("", InteractionContextExternalizer.ATR_DELTA, //$NON-NLS-1$
				...
				org.eclipse.navclus.internal.commons.core.XmlStringConverter.convertToXmlString(ie.getDelta()));
		...
		ieAttributes.addAttribute("", InteractionContextExternalizer.ATR_NAVIGATION, //$NON-NLS-1$
				...
				org.eclipse.navclus.internal.commons.core.XmlStringConverter.convertToXmlString(ie.getNavigation()));
		ieAttributes.addAttribute("", InteractionContextExternalizer.ATR_ORIGIN_ID, //$NON-NLS-1$
				...
				org.eclipse.navclus.internal.commons.core.XmlStringConverter.convertToXmlString(ie.getOriginId()));
		...
		ieAttributes.addAttribute("", InteractionContextExternalizer.ATR_STRUCTURE_HANDLE, //$NON-NLS-1$
				...
				org.eclipse.navclus.internal.commons.core.XmlStringConverter.convertToXmlString(ie.getStructureHandle()));
		ieAttributes.addAttribute("", InteractionContextExternalizer.ATR_STRUCTURE_KIND, //$NON-NLS-1$
				...
				org.eclipse.navclus.internal.commons.core.XmlStringConverter.convertToXmlString(ie.getStructureKind()));
