...
public interface LayoutAlgorithm {
	 ...
	 */
	// salee: create
	public void applyNoLayout(LayoutEntity[] entitiesToLayout, LayoutRelationship[] relationshipsToConsider, double x, double y, double width, double height, boolean asynchronous, boolean continuous) throws InvalidLayoutConfiguration;
	/**
	 * Returns whether or not the algorithm is currenly running
	 * @return True if a layout algorithm is currenly running, false otherwise
	 */
