...
public abstract class AbstractLayoutAlgorithm implements LayoutAlgorithm, Stoppable {
	...
	/**
	 * This actually applies the no layout // salee: create - only removing applyLayoutInternal ...
	 */
	public synchronized void applyNoLayout(final LayoutEntity[] entitiesToLayout, final LayoutRelationship[] relationshipsToConsider, final double x, final double y, final double width, final double height, boolean asynchronous, boolean continuous) throws InvalidLayoutConfiguration {		
		checkThread();
